...
<?php
   ...
   if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['send'])){
      ...
      if(isset($_POST['pid']) && isset($_POST['cid']) && isset($_POST['caname']) && isset($_POST['cinst_id']) && isset($_POST['cdate']) && isset($_POST['link']) ){
          $cid = $_POST['cid'];
          $pid = $_POST['pid'];
          $cname = "Amit Kumar";
          $caname = $_POST['caname'];
                ...
                <div class="details">
                      <h1>Publication Schedule</h1><hr>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT distinct publication.pid, publication.title, publication.author,publication.coauthor, publication.publisher,publication.pdate FROM publication INNER JOIN user ON publication.author = 'Amit Kumar' ";
                    ...
                    <h1>Add a New publication</h1><hr>
                        <table class="content-table">
                            ...
                            <tbody>
                                <tr>
                                <form action="editamit.php"  method="POST">
                                    <td>
