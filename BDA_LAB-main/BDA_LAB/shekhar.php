                ...
                <div class="details">
                    ...
                    <!-- Page Content -->
                        ...
                        <div class="w3-col s12 m3 l3 w3-center w3-padding" >
                            <div >	
                                <img class ="w3-circle" src="images/shekh.jpeg" width="170" height="180" alt="Avatar">
                            </div>
                        </div>
                    ...
                    <div class="w3-row w3-margin-top w3-padding-16 w3-large w3-justify"></div>
                        <center><br>
                            ...
                            <h4><strong> Presently working as Professor in the Information Technology Department of the Indian Institute of Information Technology, 
                                Allahabad.
