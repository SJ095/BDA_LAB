   ...
   if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['send'])){
      ...
      if(isset($_POST['pid']) && isset($_POST['cid']) && isset($_POST['caname']) && isset($_POST['cinst_id']) && isset($_POST['cdate']) ){
          ...
          $sql="INSERT INTO publication VALUES ('$pid','$cid','$cname','$ci_id','$cdate','$caname','$link')";
            ...
            if($query){     
                header("Location: editsonali.php");
            }
            else{
                echo 'Value exists';
            }
                ...
                <div class="details">
                      <h1>Publication Schedule</h1><hr>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT distinct publication.pid, publication.title, publication.author,publication.coauthor, publication.publisher,publication.pdate  FROM publication INNER JOIN user ON publication.author = 'Sonali Agarwal' ";
                    ...
                    <h1>Add a New publication</h1><hr>
                        <table class="content-table">
                            ...
                            <tbody>
                                <tr>
                                <form action="editsonali.php"  method="POST">
                                    <td>
