        ...
        <div class="container">
            <div class="navigation">
                <ul>
                    ...
                    <li>
                        <a href="editashutosh.php">
                            <span class="icon">
                                <ion-icon name="school"></ion-icon>
                            </span>
                            <span class="title">Edit Publications</span>
                        </a>
                    </li>
                    <li>
                        <a href="logout.php">
                ...
                <div class="details">
                    ...
                    <!-- Page Content -->
                        ...
                        <div class="w3-col s12 m3 l3 w3-center w3-padding" >
                            <div >	
                                <img class ="w3-circle" src="images/ashutosh.jpg" width="170" height="180" alt="Avatar">
                            </div>
                        </div>
                        <div class="w3-col s12 m4 l3 w3-padding w3-center">
                            <center>
                                <h1><b>Ashutosh Kumar</b></h1>
                                ...
                                <h3><strong>Big Data Analytics Lab</strong>
                                    ...
                                    <br>Prayagraj, India </h3> <br>
                                    <h5><strong>Lab: CC-3, 5241 <br>
                                    Email: ashutosh@iiita.ac.in <br>
                    ...
                    <hr> <center>
                        ...
                        $sql = "SELECT distinct publication.title, publication.author, publication.publisher,publication.pdate,publication.coauthor,publication.link FROM publication INNER JOIN user ON publication.author = 'Ashutosh Kumar' ";
